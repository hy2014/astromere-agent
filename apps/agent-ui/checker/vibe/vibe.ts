...
export abstract class Vibe {
  ...
  /** 返回本 Vibe 自有子节点产生的 status，不含继承 */
  protected ownStatus(): VibeStatus[] {
    return this.status.slice(this._inheritedCount);
  }
