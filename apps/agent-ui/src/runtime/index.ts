...
export const removeWorkspaceRegistryEntry: AgentRuntime["removeWorkspaceRegistryEntry"] = ((...args: Parameters<AgentRuntime["removeWorkspaceRegistryEntry"]>) => getCurrentRuntime().removeWorkspaceRegistryEntry(...args)) as AgentRuntime["removeWorkspaceRegistryEntry"];
...
export const loadDwSettings: AgentRuntime["loadDwSettings"] = ((...args: Parameters<AgentRuntime["loadDwSettings"]>) => getCurrentRuntime().loadDwSettings(...args)) as AgentRuntime["loadDwSettings"];
export const saveDwSettings: AgentRuntime["saveDwSettings"] = ((...args: Parameters<AgentRuntime["saveDwSettings"]>) => getCurrentRuntime().saveDwSettings(...args)) as AgentRuntime["saveDwSettings"];
...
export const getAgentContextUsage: AgentRuntime["getAgentContextUsage"] = ((...args: Parameters<AgentRuntime["getAgentContextUsage"]>) => getCurrentRuntime().getAgentContextUsage(...args)) as AgentRuntime["getAgentContextUsage"];
